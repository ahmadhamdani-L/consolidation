...
type service struct {
	Repository     repository.JcteDetail
...
type Service interface {
	Find(ctx *abstraction.Context, payload *dto.JcteDetailGetRequest) (*dto.JcteDetailGetResponse, error)
	FindByID(ctx *abstraction.Context, payload *dto.JcteDetailGetByIDRequest) (*dto.JcteDetailGetByIDResponse, error)
	Create(ctx *abstraction.Context, payload *dto.JcteDetailCreateRequest) (*dto.JcteDetailCreateResponse, error)
	Delete(ctx *abstraction.Context, payload *dto.JcteDetailDeleteRequest) (*dto.JcteDetailDeleteResponse, error)
	Update(ctx *abstraction.Context, payload *dto.JcteDetailUpdateRequest) (*dto.JcteDetailUpdateResponse, error)
}

func NewService(f *factory.Factory) *service {
	repository := f.JcteDetailRepository
	JcteRepository := f.JcteRepository
	JpmRepository := f.JpmRepository
	db := f.Db
	return &service{
		Repository:     repository,
		JcteRepository: JcteRepository,
...
func (s *service) Find(ctx *abstraction.Context, payload *dto.JcteDetailGetRequest) (*dto.JcteDetailGetResponse, error) {
	data, info, err := s.Repository.Find(ctx, &payload.JcteDetailFilterModel, &payload.Pagination)
	if err != nil {
		return &dto.JcteDetailGetResponse{}, response.ErrorBuilder(&response.ErrorConstant.InternalServerError, err)
	}

	result := &dto.JcteDetailGetResponse{
		Datas:          *data,
		PaginationInfo: *info,
	}
	return result, nil
...
func (s *service) FindByID(ctx *abstraction.Context, payload *dto.JcteDetailGetByIDRequest) (*dto.JcteDetailGetByIDResponse, error) {
	data, err := s.Repository.FindByID(ctx, &payload.ID)
	if err != nil {
		return &dto.JcteDetailGetByIDResponse{}, response.ErrorBuilder(&response.ErrorConstant.InternalServerError, err)
	}
	result := &dto.JcteDetailGetByIDResponse{
		JcteDetailEntityModel: *data,
	}
	return result, nil
}

func (s *service) Create(ctx *abstraction.Context, payload *dto.JcteDetailCreateRequest) (*dto.JcteDetailCreateResponse, error) {
	// var data model.JcteEntityModel
	var data1 model.JcteDetailEntityModel
	...
	if err := trxmanager.New(s.Db).WithTrx(ctx, func(ctx *abstraction.Context) error {
		...
		JcteID, err := s.JcteRepository.FindByID(ctx, &payload.ID)
		if err != nil {
			return err
		}
		var arrJcteDetails []model.JcteDetailEntityModel
		for _, v := range *FindAjeDetail {
			...
			findCoa, err := s.JcteRepository.FindByCoa(ctx, &v.CoaCode)
			if err != nil {
			...
			findCoaType, err := s.JcteRepository.FindByCoaType(ctx, &findCoa.CoaTypeID)
			if err != nil {
			...
			findCoaGroup, err := s.JcteRepository.FindByCoaGroup(ctx, &findCoaType.CoaGroupID)
			if err != nil {
			...
			if findCoaGroup.Name == "ASET" {
				...
				tbID, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &v.CoaCode)
				if err != nil {
				...
				findConsoleBridge, err := s.JcteRepository.FindByConsoleBridge(ctx, &JcteID.ConsolidationID)
				if err != nil {
				...
				for _, cb := range *findConsoleBridge {
					findConsoleBridgeDetail, err := s.JcteRepository.FindByConsoleBridgeDetail(ctx, &cb.ID, &v.CoaCode)
					_, err = s.JcteRepository.UpdateTbd(ctx, &tbID.ID, tbID)
					if err != nil {
				...
				arrJcteDetails = append(arrJcteDetails, v)
			}
			...
			// 	tbID, err := s.JcteJcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &v.CoaCode )
			// 	if err != nil {
			// 		return response.CustomErrorBuilder(http.StatusBadRequest, "Tidak Dapat Menemukan Coa "  + v.CoaCode, "Tidak Dapat Menemukan Coa "  + v.CoaCode)
			// 	}
			...
			// tbID.ConsolidationDetailEntity.AmountJcteCr = &AmountAjeCr
			// tbID.ConsolidationDetailEntity.AmountJcteDr = &AmountAjeDr
			// AmountAfterJcte := +*tbID.AmountAfterJpm + *tbID.AmountJcteDr - *tbID.AmountJcteDr
			// tbID.AmountAfterJcte = &AmountAfterJcte
			...
			// 		return err
			// 	}
			// 	arrJcteDetails = append(arrJcteDetails, JcteDetail)
		}
		...
		for _, v := range datas {
			...
			_, err := s.Repository.Create(ctx, &JcteDetail)
			if err != nil {
				fmt.Println(err)
				return err
			}
			data, err := s.JcteRepository.FindByID(ctx, &payload.ID)
			if err != nil {
				fmt.Println(err)
				return err
			}
			findCoa, err := s.JcteRepository.FindByCoa(ctx, &JcteDetail.CoaCode)
			if err != nil {
			...
			if findCoaGroup.Name == "ASET" {
				...
				tbID, err := s.JcteRepository.FindByTbd(ctx, &data.ConsolidationID, &JcteDetail.CoaCode)
				if err != nil {
				...
				findConsoleBridge, err := s.JcteRepository.FindByConsoleBridge(ctx, &data.ConsolidationID)
				if err != nil {
					return response.CustomErrorBuilder(http.StatusBadRequest, "Tidak Dapat Menemukan Anak Usaha ", "Tidak Dapat Menemukan Anak Usaha ")
				}
		...
		for _, v := range *formatterDetailSumData {
			...
			if v.Code == "LABA_BERSIH" {
				...
				customRowOne, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
				...
				code = "310402002"
				criteriaTBDetail.Code = &code
				customRowTwo, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310501002"
				criteriaTBDetail.Code = &code
				customRowThree, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310502002"
				criteriaTBDetail.Code = &code
				customRowFour, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310503002"
				criteriaTBDetail.Code = &code
				customRowFive, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataReFa, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataFinIn, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataIncomeTax, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataForex, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataIncomeTax2, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "LABA_BERSIH"
				criteriaTBDetail.Code = &code
				dataLaba, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataKomprehensif, err := s.JcteRepository.FindByTbd(ctx, &JcteID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
		...
		return &dto.JcteDetailCreateResponse{}, err
	}

	result := &dto.JcteDetailCreateResponse{
		JcteDetail: datas,
	}
	return result, nil
}

func (s *service) Update(ctx *abstraction.Context, payload *dto.JcteDetailUpdateRequest) (*dto.JcteDetailUpdateResponse, error) {
	...
	if err := trxmanager.New(s.Db).WithTrx(ctx, func(ctx *abstraction.Context) error {
		...
		data.Context = ctx
		data.JcteDetailEntity = payload.JcteDetailEntity
		...
		return &dto.JcteDetailUpdateResponse{}, err
	}
	result := &dto.JcteDetailUpdateResponse{
		JcteDetailEntityModel: data,
	}
	return result, nil
}
