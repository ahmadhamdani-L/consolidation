...
// @Produce json
// @Security BearerAuth
// @param request query dto.MutasiFaGetRequest true "request query"
// @Success 200 {object} dto.MutasiFaGetResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa [get]
func (h *handler) Get(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaGetRequest)
...
// @Success 200 {object} dto.MutasiFaGetByIDResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa/{id} [get]
func (h *handler) GetByID(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaGetByIDRequest)
...
func (h *handler) Create(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaCreateRequest)
...
// @Security BearerAuth
// @param id path int true "id path"
// @param request body dto.MutasiFaUpdateRequest true "request body"
// @Success 200 {object} dto.MutasiFaUpdateResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa/{id} [patch]
func (h *handler) Update(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaUpdateRequest)
...
// @Security BearerAuth
// @param id path int true "id path"
// @Success 200 {object} dto.MutasiFaDeleteResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa/{id} [delete]
func (h *handler) Delete(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaDeleteRequest)
...
// @Produce json
// @Security BearerAuth
// @param mutasi_fa_id query int true "mutasi_fa_id query"
// @Success 200 {object} dto.MutasiFaExportResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa/export [get]
func (h *handler) Export(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiFaExportRequest)
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-fa/get-version [get]
