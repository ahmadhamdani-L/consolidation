...
// Get
// @Summary Get Mutasi IA
// @Description Get Mutasi IA
// @Tags Mutasi IA
// @Accept json
// @Produce json
// @Security BearerAuth
// @param request query dto.MutasiIaGetRequest true "request query"
// @Success 200 {object} dto.MutasiIaGetResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia [get]
func (h *handler) Get(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaGetRequest)
...
// @Success 200 {object} dto.MutasiIaGetByIDResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia [get]
func (h *handler) GetByID(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaGetByIDRequest)
...
func (h *handler) Create(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaCreateRequest)
...
// @Security BearerAuth
// @param id path int true "id path"
// @param request body dto.MutasiIaUpdateRequest true "request body"
// @Success 200 {object} dto.MutasiIaUpdateResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia/{id} [patch]
func (h *handler) Update(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaUpdateRequest)
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia [delete]
func (h *handler) Delete(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaDeleteRequest)
...
// @Produce json
// @Security BearerAuth
// @param mutasi_ia_id query int true "mutasi_ia_id query"
// @Success 200 {object} dto.MutasiIaExportResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia/export [get]
func (h *handler) Export(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.MutasiIaExportRequest)
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /mutasi-ia/get-version [get]
