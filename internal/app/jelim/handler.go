...
// @Produce json
// @Security BearerAuth
// @param request query dto.JelimGetRequest true "request query"
// @Success 200 {object} dto.JelimGetResponseDoc
...
func (h *handler) Get(c echo.Context) error {
	...
	payload := new(dto.JelimGetRequest)
...
// @Success 200 {object} dto.JelimGetByIDResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jelim/{id} [get]
func (h *handler) GetByID(c echo.Context) error {
	...
	payload := new(dto.JelimGetByIDRequest)
	if err = c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h *handler) Update(c echo.Context) error {
	...
	payload := new(dto.JelimUpdateRequest)
	if err = c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
// @Produce json
// @Security BearerAuth
// @param request body dto.JelimCreateRequest true "request body"
// @Success 200 {object} dto.JelimCreateResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jelim [post]
func (h *handler) Create(c echo.Context) error {
	...
	payload := new(dto.JelimCreateRequest)
...
// @Security BearerAuth
// @Param id path int true "id path"
// @Success 200 {object}  dto.JelimDeleteResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jelim/{id} [delete]
func (h *handler) Delete(c echo.Context) error {
	cc := c.(*abstraction.Context)

	payload := new(dto.JelimDeleteRequest)
	if err := c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err := c.Validate(payload); err != nil {
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jelim/export [get]
func (h *handler) Export(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.JelimExportRequest)
...
// 	waktu := time.Now()
// 	testing := fmt.Sprintf("Jurnaljelim.xlsx")
// 	map1 := kafka.JsonData{
// 		FileLoc:   testing,
// 		UserID:    1,
// 		CompanyID: 1,
