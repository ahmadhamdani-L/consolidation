...
// @Tags Aging Utang Piutang
// @Accept json
// @Produce json
// @Security BearerAuth
// @param request query dto.AgingUtangPiutangGetRequest true "request query"
// @Success 200 {object} dto.AgingUtangPiutangGetResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang [get]
func (h *handler) Get(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangGetRequest)
...
// @Success 200 {object} dto.AgingUtangPiutangGetByIDResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang/{id} [get]
func (h *handler) GetByID(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangGetByIDRequest)
...
func (h *handler) Create(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangCreateRequest)
...
// @Security BearerAuth
// @param id path int true "id path"
// @param request body dto.AgingUtangPiutangUpdateRequest true "request body"
// @Success 200 {object} dto.AgingUtangPiutangUpdateResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang/{id} [patch]
func (h *handler) Update(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangUpdateRequest)
...
// @Security BearerAuth
// @param id path int true "id path"
// @Success 200 {object} dto.AgingUtangPiutangDeleteResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang/{id} [delete]
func (h *handler) Delete(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangDeleteRequest)
...
// @Produce json
// @Security BearerAuth
// @param aging_utang_piutang_id query int true "aging_utang_piutang_id query"
// @Success 200 {object} dto.AgingUtangPiutangExportResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang/export [get]
func (h *handler) Export(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangExportRequest)
...
func (h *handler) ExportAsync(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.AgingUtangPiutangExportAsyncRequest)
	fmt.Println(cc)
	waktu := time.Now()
	msg := kafka.JsonData{
		UserID:    1,
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /aging-utang-piutang/get-version [get]
