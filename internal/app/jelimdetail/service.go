...
type service struct {
	Repository      repository.JelimDetail
...
type Service interface {
	Find(ctx *abstraction.Context, payload *dto.JelimDetailGetRequest) (*dto.JelimDetailGetResponse, error)
	FindByID(ctx *abstraction.Context, payload *dto.JelimDetailGetByIDRequest) (*dto.JelimDetailGetByIDResponse, error)
	Create(ctx *abstraction.Context, payload *dto.JelimDetailCreateRequest) (*dto.JelimDetailCreateResponse, error)
	Delete(ctx *abstraction.Context, payload *dto.JelimDetailDeleteRequest) (*dto.JelimDetailDeleteResponse, error)
	Update(ctx *abstraction.Context, payload *dto.JelimDetailUpdateRequest) (*dto.JelimDetailUpdateResponse, error)
}

func NewService(f *factory.Factory) *service {
	repository := f.JelimDetailRepository
	JelimRepository := f.JelimRepository
	JpmRepository := f.JpmRepository
	db := f.Db
	return &service{
		Repository:      repository,
		JelimRepository: JelimRepository,
		JpmRepository:   JpmRepository,
		Db:              db,
	}
}

func (s *service) Find(ctx *abstraction.Context, payload *dto.JelimDetailGetRequest) (*dto.JelimDetailGetResponse, error) {
	data, info, err := s.Repository.Find(ctx, &payload.JelimDetailFilterModel, &payload.Pagination)
	if err != nil {
		return &dto.JelimDetailGetResponse{}, response.ErrorBuilder(&response.ErrorConstant.InternalServerError, err)
	}

	result := &dto.JelimDetailGetResponse{
		Datas:          *data,
		PaginationInfo: *info,
	}
	return result, nil
...
func (s *service) FindByID(ctx *abstraction.Context, payload *dto.JelimDetailGetByIDRequest) (*dto.JelimDetailGetByIDResponse, error) {
	data, err := s.Repository.FindByID(ctx, &payload.ID)
	if err != nil {
		return &dto.JelimDetailGetByIDResponse{}, response.ErrorBuilder(&response.ErrorConstant.InternalServerError, err)
	}
	result := &dto.JelimDetailGetByIDResponse{
		JelimDetailEntityModel: *data,
	}
	return result, nil
}

func (s *service) Create(ctx *abstraction.Context, payload *dto.JelimDetailCreateRequest) (*dto.JelimDetailCreateResponse, error) {
	// var data model.JelimEntityModel
	var data1 model.JelimDetailEntityModel
	...
	if err := trxmanager.New(s.Db).WithTrx(ctx, func(ctx *abstraction.Context) error {
		...
		JelimID, err := s.JelimRepository.FindByID(ctx, &payload.ID)
		if err != nil {
			return err
		}
		...
		for _, v := range *FindAjeDetail {
			...
			JelimDetail.ID = v.ID
			data, err := s.JelimRepository.FindByID(ctx, &payload.ID)
			if err != nil {
				return err
			}

			// tbID, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &v.CoaCode )
			// if err != nil {
			// 	return err
			// }
			...
			// _, err = s.JelimRepository.UpdateTbd(ctx, &tbID.ID, tbID)
			// if err != nil {
			// 	return err
			// }
			// arrJelimDetails = append(arrJelimDetails, JelimDetail)
			findCoa, err := s.JelimRepository.FindByCoa(ctx, &v.CoaCode)
			if err != nil {
			...
			findCoaType, err := s.JelimRepository.FindByCoaType(ctx, &findCoa.CoaTypeID)
			if err != nil {
			...
			findCoaGroup, err := s.JelimRepository.FindByCoaGroup(ctx, &findCoaType.CoaGroupID)
			if err != nil {
			...
			if findCoaGroup.Name == "ASET" {
				...
				tbID, err := s.JelimRepository.FindByTbd(ctx, &data.ConsolidationID, &v.CoaCode)
				if err != nil {
		...
		for _, v := range datas {
			...
			_, err := s.Repository.Create(ctx, &JelimDetail)
			if err != nil {
				fmt.Println(err)
				return err
			}
			...
			// tbID, err := s.JelimRepository.FindByTbd(ctx, &dataAje.ConsolidationID, &v.CoaCode)
		...
		for _, v := range *formatterDetailSumData {
			...
			if v.Code == "LABA_BERSIH" {
				...
				customRowOne, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
				...
				code = "310402002"
				criteriaTBDetail.Code = &code
				customRowTwo, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310501002"
				criteriaTBDetail.Code = &code
				customRowThree, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310502002"
				criteriaTBDetail.Code = &code
				customRowFour, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "310503002"
				criteriaTBDetail.Code = &code
				customRowFive, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataReFa, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataFinIn, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataIncomeTax, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataForex, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataIncomeTax2, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				code = "LABA_BERSIH"
				criteriaTBDetail.Code = &code
				dataLaba, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
				...
				criteriaTBDetail.Code = &code
				dataKomprehensif, err := s.JelimRepository.FindByTbd(ctx, &JelimID.ConsolidationID, &code)
				if err != nil {
					return helper.ErrorHandler(err)
				}
		...
		return &dto.JelimDetailCreateResponse{}, err
	}

	result := &dto.JelimDetailCreateResponse{
		JelimDetail: datas,
	}
	return result, nil
}

func (s *service) Update(ctx *abstraction.Context, payload *dto.JelimDetailUpdateRequest) (*dto.JelimDetailUpdateResponse, error) {
	...
	if err := trxmanager.New(s.Db).WithTrx(ctx, func(ctx *abstraction.Context) error {
		...
		data.Context = ctx
		data.JelimDetailEntity = payload.JelimDetailEntity
		...
		return &dto.JelimDetailUpdateResponse{}, err
	}
	result := &dto.JelimDetailUpdateResponse{
		JelimDetailEntityModel: data,
	}
	return result, nil
}
