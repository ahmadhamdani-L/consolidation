...
// @Produce json
// @Security BearerAuth
// @param request query dto.JcteGetRequest true "request query"
// @Success 200 {object} dto.JcteGetResponseDoc
...
func (h *handler) Get(c echo.Context) error {
	...
	payload := new(dto.JcteGetRequest)
...
// @Success 200 {object} dto.JcteGetByIDResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jcte/{id} [get]
func (h *handler) GetByID(c echo.Context) error {
	...
	payload := new(dto.JcteGetByIDRequest)
	if err = c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h *handler) Update(c echo.Context) error {
	...
	payload := new(dto.JcteUpdateRequest)
	if err = c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
// @Produce json
// @Security BearerAuth
// @param request body dto.JcteCreateRequest true "request body"
// @Success 200 {object} dto.JcteCreateResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jcte [post]
func (h *handler) Create(c echo.Context) error {
	...
	payload := new(dto.JcteCreateRequest)
...
// @Security BearerAuth
// @Param id path int true "id path"
// @Success 200 {object}  dto.JcteDeleteResponseDoc
// @Failure 400 {object} response.errorResponse
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jcte/{id} [delete]
func (h *handler) Delete(c echo.Context) error {
	cc := c.(*abstraction.Context)

	payload := new(dto.JcteDeleteRequest)
	if err := c.Bind(payload); err != nil {
		return response.ErrorBuilder(&response.ErrorConstant.BadRequest, err).Send(c)
	}
	if err := c.Validate(payload); err != nil {
...
// @Failure 404 {object} response.errorResponse
// @Failure 500 {object} response.errorResponse
// @Router /jcte/export [get]
func (h *handler) Export(c echo.Context) error {
	cc := c.(*abstraction.Context)
	payload := new(dto.JcteExportRequest)
...
// 	waktu := time.Now()
// 	testing := fmt.Sprintf("Jurnaljcte.xlsx")
// 	map1 := kafka.JsonData{
// 		FileLoc:   testing,
// 		UserID:    1,
// 		CompanyID: 1,
