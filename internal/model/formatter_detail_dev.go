...
type FormatterDetailDevEntity struct {
	...
	FormatterDevID    int   `json:"formatter_dev_id" `
...
type FormatterDetailDevFilter struct {
	...
	FormatterDevID *int   `query:"formatter_dev_id" example:"1"`
...
type FormatterDetailDevEntityModel struct {
	// abstraction
	ID int `json:"id" gorm:"primaryKey;autoIncrement;"`

	// entity
	FormatterDetailDevEntity

	// relations
	// SampleChilds []SampleChildEntityModel `json:"sample_childs" gorm:"foreignKey:SampleID"`
	Formatter FormatterEntityModel `json:"formatter" gorm:"foreignKey:FormatterDevID"`

	// context
	Context *abstraction.Context `json:"-" gorm:"-"`
}

type FormatterDetailDevFilterModel struct {
	// abstraction

	// filter
	FormatterDetailDevFilter
}
type FormatterDetailDevFmtEntityModel struct {
	FormatterDetailDevEntityModel
	FormatterDetailDevID int                                `json:"formatter_detail_id"`
	ParentID          int                                `json:"parent_id"`
	AutoSummary       bool                               `json:"auto_summary"`
	IsTotal           bool                               `json:"is_total"`
	IsControl         bool                               `json:"is_control"`
	...
	CoaGroupID		  *int 								 `json:"coa_group_id" `
	Children          []FormatterDetailDevFmtEntityModel 	 `json:"children" gorm:"-"`
	ShowGroupCoa      *bool   `json:"show_group_coa"`
}
func (FormatterDetailDevEntityModel) TableName() string {
	return "m_formatter_detail_dev"
}
