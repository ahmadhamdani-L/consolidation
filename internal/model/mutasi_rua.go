...
type MutasiRuaEntityModel struct {
	...
	MutasiRuaCostDetail []MutasiRuaDetailEntityModel `json:"mutasi_rua_cost_detail" gorm:"-"`
	MutasiRuaADDetail   []MutasiRuaDetailEntityModel `json:"mutasi_rua_accumulated_depreciation_detail" gorm:"-"`
	UserRelationModel
