...
type EmployeeBenefit interface {
	Find(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel, p *abstraction.Pagination) (*[]model.EmployeeBenefitEntityModel, *abstraction.PaginationInfo, error)
	FindByID(ctx *abstraction.Context, id *int) (*model.EmployeeBenefitEntityModel, error)
	...
	Delete(ctx *abstraction.Context, id *int, e *model.EmployeeBenefitEntityModel) (*model.EmployeeBenefitEntityModel, error)
	GetCount(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel) (*int64, error)
	GetVersion(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel) (*model.GetVersionModel, error)
	FindByCriteria(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel) (*model.EmployeeBenefitEntityModel, error)
}
...
func (r *employeebenefit) Find(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel, p *abstraction.Pagination) (*[]model.EmployeeBenefitEntityModel, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)
	...
	//filter
	tableName := model.EmployeeBenefitEntityModel{}.TableName()
	query = r.FilterTable(ctx, query, *m, model.EmployeeBenefitEntityModel{}.TableName())
	...
	query = r.FilterMultiVersion(ctx, query, m.EmployeeBenefitFilter)
	query = query.Where("employee_benefit.status != 0")
	query = query.Joins(`INNER JOIN "imported_worksheet" "Import" ON "Import"."company_id" = "employee_benefit"."company_id" 
	AND "Import"."period" = "employee_benefit"."period" 
	AND "Import"."versions" = "employee_benefit"."versions" 
	...
	if p.SortBy != nil && (tmpSortBy != nil && *tmpSortBy != "company" && *tmpSortBy != "user") {
		sortBy := fmt.Sprintf("employee_benefit.%s", *p.SortBy)
		p.SortBy = &sortBy
	}
...
func (r *employeebenefit) FindByID(ctx *abstraction.Context, id *int) (*model.EmployeeBenefitEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *employeebenefit) Destroy(ctx *abstraction.Context, id *int, e *model.EmployeeBenefitEntityModel) (*model.EmployeeBenefitEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *employeebenefit) Delete(ctx *abstraction.Context, id *int, e *model.EmployeeBenefitEntityModel) (*model.EmployeeBenefitEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *employeebenefit) GetVersion(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel) (*model.GetVersionModel, error) {
	var data []model.EmployeeBenefitEntityModel
	conn := r.CheckTrx(ctx)
	query := conn.Model(&model.EmployeeBenefitEntityModel{})
	query = r.Filter(ctx, query, *m)
...
func (r *employeebenefit) FindByCriteria(ctx *abstraction.Context, m *model.EmployeeBenefitFilterModel) (*model.EmployeeBenefitEntityModel, error) {
	conn := r.CheckTrx(ctx)
	var data model.EmployeeBenefitEntityModel
	query := conn.Model(&model.EmployeeBenefitEntityModel{})
	query = r.Filter(ctx, query, *m)
