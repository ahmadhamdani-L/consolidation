...
type MutasiFa interface {
	Find(ctx *abstraction.Context, m *model.MutasiFaFilterModel, p *abstraction.Pagination) (*[]model.MutasiFaEntityModel, *abstraction.PaginationInfo, error)
	FindByID(ctx *abstraction.Context, id *int) (*model.MutasiFaEntityModel, error)
	Create(ctx *abstraction.Context, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error)
	Update(ctx *abstraction.Context, id *int, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error)
	Delete(ctx *abstraction.Context, id *int, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error)
	GetCount(ctx *abstraction.Context, m *model.MutasiFaFilterModel) (*int64, error)
	GetVersion(ctx *abstraction.Context, m *model.MutasiFaFilterModel) (*model.GetVersionModel, error)
...
func (r *mutasifa) Find(ctx *abstraction.Context, m *model.MutasiFaFilterModel, p *abstraction.Pagination) (*[]model.MutasiFaEntityModel, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)
	...
	//filter
	tableName := model.MutasiFaEntityModel{}.TableName()
	...
	query = r.FilterMultiVersion(ctx, query, m.MutasiFaFilter)
	queryUser := conn.Model(&model.UserEntityModel{}).Select("id")
	query = r.FilterUser(ctx, query, queryUser, m.Filter, tableName)
	query = query.Where("mutasi_fa.status != 0")
	query = query.Joins(`INNER JOIN "imported_worksheet" "Import" ON "Import"."company_id" = "mutasi_fa"."company_id" 
	AND "Import"."period" = "mutasi_fa"."period" 
	AND "Import"."versions" = "mutasi_fa"."versions" 
	...
	if p.SortBy != nil && (tmpSortBy != nil && *tmpSortBy != "company" && *tmpSortBy != "user") {
		sortBy := fmt.Sprintf("mutasi_fa.%s", *p.SortBy)
		p.SortBy = &sortBy
	}
...
func (r *mutasifa) FindByID(ctx *abstraction.Context, id *int) (*model.MutasiFaEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *mutasifa) Create(ctx *abstraction.Context, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *mutasifa) Destroy(ctx *abstraction.Context, id *int, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *mutasifa) Delete(ctx *abstraction.Context, id *int, e *model.MutasiFaEntityModel) (*model.MutasiFaEntityModel, error) {
	conn := r.CheckTrx(ctx)
...
func (r *mutasifa) GetVersion(ctx *abstraction.Context, m *model.MutasiFaFilterModel) (*model.GetVersionModel, error) {
	var data []model.MutasiFaEntityModel
	conn := r.CheckTrx(ctx)
	query := conn.Model(&model.MutasiFaEntityModel{})
	query = r.Filter(ctx, query, *m)
