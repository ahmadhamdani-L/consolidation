...
type InvestasiTbk interface {
	...
	FindByID(ctx *abstraction.Context, version *int, company *int, period *string) (*model.InvestasiTbkEntityModel, error)
}
...
func (r *investasitbk) FindByID(ctx *abstraction.Context, version *int, company *int, period *string) (*model.InvestasiTbkEntityModel, error) {
	conn := r.CheckTrx(ctx)
